...
const { layoutDay, PX_PER_HOUR, CARD_GAP, CARD_H, CARD_H_TINY, tickStepFor, zoomLabelFor, clampZoom, ZOOM_MIN, ZOOM_MAX } = mod;
let failures = 0;
...
check(card('p2').h === CARD_H_TINY && card('work').h === CARD_H && !card('work').proportional, 'at the default zoom every card is compact (rails carry the duration)');
