  ...
  return (
    <View style={{ flex: 1, backgroundColor: isDark ? '#0F0F23' : '#FAFAFA' }}>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 20, paddingBottom: 60 }} showsVerticalScrollIndicator={false}>
          {kind === 'privacy' && (
            <>
              <Text style={{ fontSize: 12, color: isDark ? '#888' : '#999', marginBottom: 20 }}>Last updated: 5 September 2026</Text>
          ...
          {kind === 'support' && (
            <>
              ...
              {[
                ...
                { q: 'Can I upload my own profile photo?', a: 'Yes, but only if your email address is verified. Once verified, you will see an "Upload Your Own Photo" button below the preset avatars. Your photo will be automatically checked to ensure it is appropriate before it is accepted.' },
                { q: 'Why was my profile picture rejected?', a: 'Uploaded photos are automatically scanned to ensure they are appropriate for a family-friendly app. Photos may be rejected if they contain nudity, violence, hate symbols, offensive text, or other inappropriate content. You get three attempts. After a third rejected photo you cannot upload another custom photo until the following day (the cooldown ends at midnight).' },
                // Fitness
