...
const BibleTimeline = ({ visible, onClose, onNavigateToVerse }) => {
  ...
  const timelineData = [
    ...
    },
    {
      ...
      size: 120,
      description: 'God chooses Abraham and his family for a great adventure! Through Abraham, Isaac, Jacob, and Joseph, God builds His special nation and shows His faithfulness.',
      stories: [
        {
    ...
    },
    {
      ...
      size: 120,
      description: 'The greatest rescue mission in history! God uses Moses to free His people from slavery in Egypt through powerful miracles and shows His mighty power to the whole world.',
      stories: [
        {
    ...
    },
    {
      ...
      size: 120,
      description: 'The greatest battle campaign! Joshua leads God\'s people to conquer the Promised Land through mighty victories and powerful interventions. The land promise finally fulfilled!',
      stories: [
        {
    ...
    },
    {
      ...
      stories: [
        ...
        {
          title: 'Solomon Builds God\'s Beautiful Temple',
          ...
          story: 'Solomon fulfilled his father David\'s dream by building the most beautiful temple for God that the world had ever seen! It took seven years to build and used the finest materials - cedar wood from Lebanon, tons of gold, and beautiful decorations. When it was finished, they had a huge dedication ceremony. Solomon prayed a powerful prayer, and then something wonderful happened - God\'s glory came down like a cloud and filled the temple so completely that the priests couldn\'t even go inside! Fire came down from heaven and consumed the sacrifices. All the people fell on their faces and worshipped, saying, "He is good! His love endures forever!" The Temple became the center of Israel\'s worship and the most important building in the nation. It housed the Ark of the Covenant and was where people came to worship God and offer sacrifices.'
        },
        {
    ...
    },
    {
      ...
      size: 120,
      description: 'After Solomon\'s kingdom split in two, both Israel (north) and Judah (south) struggled with idol worship and wicked kings. God sent powerful prophets like Elijah and Elisha to call them back, but eventually both kingdoms were conquered and the people taken into exile.',
      stories: [
        {
    ...
    },
    {
      ...
      size: 120,
      description: 'When God\'s people were taken far from their homeland to live in foreign countries. Even in the darkest times, God was still with them and had wonderful plans!',
      stories: [
        {
    ...
    },
    {
      ...
      size: 120,
      description: 'The final conclusion of God\'s plan! Jesus returns as King of Kings, evil is defeated forever, and God creates a perfect new heaven and new earth where He lives with His people for eternity.',
      stories: [
        {
        ...
        },
        {
          ...
          story: 'After the final judgment, God is going to do the most wonderful thing ever - He\'s going to create a brand new heaven and a brand new earth! The old world with all its sin, death, and sadness will be completely gone. John saw a beautiful vision of the New Jerusalem (like the most perfect city) coming down from heaven, all prepared like a beautiful bride on her wedding day. The best part? God is going to live right there with people! He promises to wipe away every single tear from their eyes, and there will be no more death, no more crying, no more pain - all the bad stuff will be gone forever! The New Jerusalem is described with the most beautiful things you can imagine - streets made of pure gold and gates made of giant pearls - showing just how wonderfully glorious and pure God\'s kingdom will be. There won\'t even need to be a temple because God and Jesus will be right there with everyone! The curse that came from sin in the Garden of Eden will be completely gone, and the Tree of Life will be there again, giving fruit and healing to everyone. All the people God saved will actually get to see His face and rule with Him forever and ever! This is the perfect happy ending - God and His people living together forever in a perfect world where everything is exactly the way it\'s supposed to be. It\'s like the Garden of Eden, but even better, and it will last forever and ever with no possibility of anything ever going wrong again!'
        }
      ],
      connections: []
    }
