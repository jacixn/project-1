...
const ProgressTracker = ({ userData }) => {
  const badges = [
    { id: 'faithful_week', name: 'Faithful Week', icon: <FaTrophy />, description: 'Complete all 5 prayers for 7 days', earned: userData.badges.includes('faithful_week') },
    { id: 'early_bird', name: 'Early Bird', icon: <FaStar />, description: 'Complete pre-dawn prayer 5 days', earned: userData.badges.includes('early_bird') },
    { id: 'task_master', name: 'Task Master', icon: <FaMedal />, description: 'Complete 20 tasks in a week', earned: userData.badges.includes('task_master') },
    { id: 'verse_reader', name: 'Verse Reader', icon: <FaAward />, description: 'Read 100 verses', earned: userData.versesRead >= 100 }
  ];
      ...
      <div className="weekly-stats">
        ...
        <div className="weekly-stats-grid">
          <div className="weekly-stat">
            <span className="weekly-value">{userData.streak}</span>
            <span className="weekly-label">Day Streak</span>
          </div>
          <div className="weekly-stat">
            <span className="weekly-value">{userData.versesRead}</span>
